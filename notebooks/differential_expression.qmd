...
format:
  html:
    ...
    code-links:
      - text: Repo de GitHub
        icon: github
        href: https://github.com/justog220/TP-Final-NGS
---
...
#| code-fold: true
#| label: fig-filtrado
#| fig-cap: "Número de genes presentes antes y despúes del filtrado." 
...
Como se puede ver en @fig-filtrado se pasa de 127 genes a 100.
...
#| fig-cap: "Matriz de distancia para las 6 muestras." 
...
Como se puede ver en @fig-correlacion, las muestras se agrupan correctamente según su condición, en la jerarquía también se pueden ver correctamente diferenciadas.
...
Como se puede observar en la @fig-pca-deseq, los grupos se encuentran bien diferenciados en las dos condiciones en el eje de la primer componente principal. Por otro lado, en el eje de PC2 la varianza es muy baja.

## Volcano Plot

```{r}
#| label: fig-volcano-plot-plotly
#| fig-cap: "Volcano plot para los genes diferencialmente expresados con el tratamiento Batch vs. Quimiostato"
...
En este caso se buscó graficar genes que hayan sido contados y no codifiquen para proteínas (se tomo que no tenga `p_id` como criterio). Sólo se observa *snR18* como up regulado, al inspeccionar en el explorador genómico (@fig-ilustracion-snr18) se ve que se sitúa en un intrón de YAL003W (EFB1) una de las regiones con más cobertura, por lo que puede ser esa la razón del ruido.

![Cromosoma uno y los archivos de cobertura para cada muestra, remarcado en rojo EFB1 y dentro snR18](images/clipboard-4091810527.png){#fig-ilustracion-snr18}
...
```{r}
#| label: fig-barplot-go-biological-process-down
#| fig-cap: "Barplot of Biological processes from GO 2018 enriched"
...
```{r}
#| label: fig-dotplot-go-biological-process-down
#| fig-cap: "Dotplot of Biological processes from GO 2018 enriched"
print(dotplot)
```
...
```{r}
#| label: fig-barplot-go-cellular-component-down
#| fig-cap: "Barplot of Cellular component from GO 2018 enriched"
library_name <- "GO_Cellular_Component_2018"
enrich_df <- load_enrichment(library_name, base_dir = "../results/functional_enrichment/down_regulated")
...
```{r}
#| label: fig-dotplot-go-cellular-component-down
#| fig-cap: Dotplot of Cellular component from GO 2018 enriched
print(dotplot)
```
...
```{r}
#| label: fig-barplot-go-molecular-function-down
#| fig-cap: "Barplot of Molecular function from GO 2018 enriched"
...
```{r}
#| label: fig-dotplot-go-molecular-function-down
#| fig-cap: "Dotplot of Molecular function from GO 2018 enriched"
print(dotplot)
```
